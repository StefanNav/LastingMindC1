      ...
      <div className="max-w-2xl mx-auto px-5 py-6">
        ...
        >
          <div className="w-16 h-16 rounded-full bg-sage-light/50 flex items-center justify-center mb-4">
            <Users className="w-7 h-7 text-sage-dark" />
          </div>
          <h1 className="font-display text-2xl text-bark mb-2">Invite Audience</h1>
          <p className="text-bark-muted text-sm max-w-[280px]">
            Invite family and friends to contribute questions and view your story. This feature is coming soon.
          </p>
        </motion.div>
      </div>
    </div>
